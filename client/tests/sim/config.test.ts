...
describe('sim config', () => {
  ...
  it('uses defaults when fields are invalid', () => {
    ...
    const nanResult = parseSimConfig({
      ...
      shieldDuration: Number.NaN,
      shieldCooldown: Number.POSITIVE_INFINITY,
      shieldDamageMultiplier: Number.NaN,
      shockwaveRadius: Number.NaN,
      shockwaveImpulse: Number.POSITIVE_INFINITY,
      shockwaveCooldown: Number.NaN,
      shockwaveDamage: Number.POSITIVE_INFINITY,
  ...
  it('accepts valid numeric overrides', () => {
    const result = parseSimConfig({
      ...
      shieldDuration: 2.25,
      shieldCooldown: 6,
      shieldDamageMultiplier: 0.45,
      shockwaveRadius: 5.5,
      shockwaveImpulse: 9,
      shockwaveCooldown: 4.5,
      shockwaveDamage: 7,
      arenaHalfSize: 42,
      playerRadius: 0.4,
      playerHeight: 1.9,
